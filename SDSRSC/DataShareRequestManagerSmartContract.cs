...
{
    /// <summary>
    /// Data Share RequestsManager (DSRM) SC
    /// manages and stores data sharing requests
    /// and validates state of completed requests. 
    /// </summary>
    public class DataShareRequestManagerSmartContract : SmartContract
    {
        ...
        /// resource
        /// </summary>
        [DisplayName("dataShareRequestEvent")]
        public static event DataShareRequestAction<string, BigInteger, byte[], byte[], byte[]> DataShareRequestedEvent;
        ...
        /// </summary>
        /// <param name="requestsCounter">Total number of requests</param>
        ...
        private static void RequestNotification(string operation, BigInteger requestNumber, byte[] from, byte[] to, byte[] resource)
        {
            ...
            DataShareRequestedEvent.Invoke(operation, requestNumber, from, to, resource);
        }
    }
}
